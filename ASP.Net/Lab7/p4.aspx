<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p4.aspx.cs" Inherits="lab_7.p4" %>
...
<head runat="server">
    <title></title>
    <link href="App_Themes/lab7_4/StyleSheet1.css" rel="stylesheet" />
</head>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label Text="Select city:" runat="server" ID="lblSelect"></asp:Label>
